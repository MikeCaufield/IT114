...
public class SocketClient {
	...
	public static Thread fromServerThread;
	public static Thread clientThread;
	public static String clientName;
	public static ObjectOutputStream out;
	public final static Logger log = Logger.getLogger(SocketClient.class.getName());
	public static Event event;
	
	public static Payload buildMessage(String message) {
	...
	public static Payload buildConnectionStatus(String name, boolean isConnect) {
		Payload payload = new Payload();
		if (isConnect) {
	...
	public static void sendPayload(Payload p) {
		try {
			out.writeObject(p);
		}
		catch (IOException e) {
	...
	public static void listenForServerMessage(ObjectInputStream in) {
	 ...
	 * @param p
	 */
	public static void processPayload(Payload p) {

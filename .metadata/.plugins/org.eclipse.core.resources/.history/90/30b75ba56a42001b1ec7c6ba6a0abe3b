...
public class ServerThread extends Thread {
    ...
    public ObjectInputStream in;// from client
    public ObjectOutputStream out;// to client
    public boolean isRunning = false;
    public Room currentRoom;// what room we are in, should be lobby by default
    public String clientName;
    public final static Logger log = Logger.getLogger(ServerThread.class.getName());
    ...
    public boolean sendPayload(Payload p) {
	try {
	    out.writeObject(p);
	    return true;
	}
